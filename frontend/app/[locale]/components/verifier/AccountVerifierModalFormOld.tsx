...
export const AccountVerifierModalForm = ({closeModal}: {closeModal:  MouseEventHandler<HTMLDivElement | HTMLButtonElement> } ) => {
    ...
    const {setAccountRefresh, refreshScreen, setRefreshScreen} = useIdentityContext()
    ...
    const submitAddVerifierAccount = () => {
        writeContractByFunctionName("updateVerifierAccount", account, name, firstName, "add")
            .then(() => {
                setLoading(true)
                toast({
            ...
            <div className="fixed z-10 top-1/3 left-1/2 -translate-y-1/2 -translate-x-1/2 bg-gray-900 rounded border border-gray-800 shadow-md shadow-black/50
                ...
                <div className="flex flex-col">
                    ...
                    <button
                        ...
                        onClick={() => submitAddVerifierAccount() }
                    >Ajouter</button>
                </div>
